  ...
  <form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <div class="input-field">
        ...
        <small class="helper-text invalid" v-else-if="$v.password.$dirty && !$v.password.minLength">Пароль должен содержать более {{$v.password.params.minLength.min}} символов Сейчас он {{password.length}}</small>
      </div>
    </div>
